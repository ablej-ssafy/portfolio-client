import { GradeType, ResumeType, TemplateType } from '@/types/resume';

export const resume: ResumeType = {
  memberId: 1,
  isPrivate: false,
  templateType: TemplateType.MODERN_DARK,
  hashKey: 'someHashKey',
  basic: {
    name: '민준수',
    job: '백엔드 개발자',
    title: '안녕하세요. \n도전을 좋아하는 백엔드 개발자 민준수입니다.',
    introduce:
      '창업에 도전하여 국가지원사업을 수행하고, 교육 컨텐츠 개발과 프리랜서 개발 경험도 있습니다.\n 프로젝트에서 백엔드 서버 개발을 주로 담당했으며, Spring, Django 등의 프레임워크를 활용한 RESTful API 서버 개발에 능숙합니다. \n실시간 데이터 처리, 안정적인 시스템 설계, CI/CD 환경 구축 등의 경험도 있습니다. 이론과 실무를 겸비한 개발자로 성장하고 있으며, 새로운 기술 습득과 도전에 대한 열정이 있습니다.',
    profileImage: 'https://storage.surfit.io/career/avatar/w8NDq/80642042765d736f48f79b.png',
    email: 'sunsuking@gmail.com',
    phoneNumber: '010-9995-5678',
    github: 'sunsuking',
  ...
  projects: [
    ...
    },
    {
      ...
      startAt: new Date('2024-06'),
      endAt: new Date('2024-08'),
      description:
  ...
  educationals: [
    {
      ...
      startAt: new Date('2020-03'),
      endAt: new Date('2024-02'),
      educationalId: 1,
    },
    {
      name: '전남여자고등학교',
